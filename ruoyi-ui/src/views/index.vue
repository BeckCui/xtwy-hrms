<template>
  <div class="app-container home">
    <el-row :gutter="24" style="margin-bottom: 5px;">
      <el-col :sm="6" :lg="6" style="padding-right: 0px">
        <el-card class="update-log card-body">
          <div class="body">
            <el-row :gutter="24" class="card-item">
              <el-col :sm="10" :lg="10">
                <img src="@/assets/images/personinfo.png">
              </el-col>
              <el-col :sm="14" :lg="15">
                <div class="card-title">人员信息管理</div>
                <div class="card-detail-info">管理人员档案数据及附件</div>
              </el-col>
            </el-row>
          </div>
        </el-card>
      ...
      <el-col :sm="6" :lg="6" style="padding-right: 0px">
        <el-card class="update-log card-body">
          <div class="body">
            <el-row :gutter="24" class="card-item">
              <el-col :sm="10" :lg="10" style="background: #E26079">
                <img src="@/assets/images/personinfo.png">
              </el-col>
              <el-col :sm="14" :lg="15">
                <div class="card-title">考核管理</div>
                <div class="card-detail-info">
                  <span style="margin-right: 3px;">申请</span>
                  <span style="margin-right: 3px;">审核</span>
                  <span>评分</span>
                </div>
              </el-col>
            </el-row>
      ...
      <el-col :sm="6" :lg="6" style="padding-right: 0px">
        <el-card class="update-log card-body">
          <div class="body">
            <el-row :gutter="24" class="card-item">
              <el-col :sm="10" :lg="10" style="background: #6FCB71">
                <img src="@/assets/images/personinfo.png">
              </el-col>
              <el-col :sm="14" :lg="15">
                <div class="card-title">福利管理</div>
                <!--                <div class="card-detail-info">管理人员档案数据及附件</div>-->
              </el-col>
            </el-row>
          </div>
      ...
      <el-col :sm="6" :lg="6" style="padding-right: 0px">
        <el-card class="update-log card-body">
          <div class="body">
            <el-row :gutter="24" class="card-item">
              <el-col :sm="10" :lg="10" style="background: #F4D426">
                <img src="@/assets/images/personinfo.png">
              </el-col>
              <el-col :sm="14" :lg="15">
                <div class="card-title">在位率管理</div>
                <div class="card-detail-info" style="    margin-top: 10px;">
                  <span style="margin-right: 10px;">请销假</span>
                  <span style="margin-right: 3px;">之行任务</span>
                  <span style="margin-top: 3px;">进修学习</span>
                </div>
              </el-col>
            </el-row>
          </div>
    ...
    <el-row :gutter="24">
      <el-col :sm="16" :lg="18">
        <el-row :gutter="24" style="margin-bottom: 5px;">
          <el-col :sm="12" :lg="12" style="padding-right: 0px">
            <el-card class="update-log">
              <div slot="header" class="clearfix">
                <b style="color: #606266">学历分布</b>
              </div>
              <div ref="grade_id_education" style="height: 220px;"></div>
            </el-card>
          </el-col>
          <el-col :sm="12" :lg="12" style="padding-right: 0px">
            <el-card class="update-log">
              <div slot="header" class="clearfix">
                <b style="color: #606266">按年龄阶段分布</b>
              </div>
              <div ref="grade_id_age" style="height: 220px;"></div>
            </el-card>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :sm="8" :lg="8" style="padding-right: 0px">
            <el-card class="update-log">
              <div slot="header" class="clearfix">
                <b style="color: #606266">人员类别在位情况分布</b>
              </div>
              <div ref="grade_id_online" style="height: 220px;"></div>
            </el-card>
          </el-col>
          <el-col :sm="8" :lg="8" style="padding-right: 0px">
            <el-card class="update-log">
              <div slot="header" class="clearfix">
                <b style="color: #606266">职称分布占比</b>
              </div>
              <div ref="grade_id_job" style="height: 220px;"></div>
            </el-card>
          </el-col>
          <el-col :sm="8" :lg="8" style="padding-right: 0px">
            <el-card class="update-log">
              <div slot="header" class="clearfix">
                <b style="color: #606266">人员类型分布占比</b>
              </div>
              <div ref="grade_id_perclassify" style="height: 220px;"></div>
            </el-card>
          </el-col>
        </el-row>
      </el-col>
      <el-col :sm="6" :lg="6" style="padding-right: 0px">
        <el-card class="update-log">
          <div slot="header" class="clearfix">
            <b style="color: #606266">待办事项</b>
          </div>
          <div class="wait_todo_list">
            <ul>
              <li><span>神经内科提交考核材料，请及时审核</span><br/><span>2023年3月3日</span></li>
              <li><span>神经内科提交考核材料，请及时审核</span><br/><span>2023年3月3日</span></li>
              <li><span>神经内科提交考核材料，请及时审核</span><br/><span>2023年3月3日</span></li>
              <li><span>神经内科提交考核材料，请及时审核</span><br/><span>2023年3月3日</span></li>
              <li><span>神经内科提交考核材料，请及时审核</span><br/><span>2023年3月3日</span></li>
    ...
    <!--
        ...
        <el-row :gutter="20">
          <el-col :sm="24" :lg="12" style="padding-left: 20px">
            <h2>若依后台管理框架</h2>
            <p>
              一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套后台系统。如此有了考核管理系统，她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
            </p>
            <p>
...
export default {
  ...
  data() {
    return {
      ...
      version: "3.8.5",
      edu_option: {
        color: ["#3aa0fd", "#36caca", "#fad337", "#4eca73", "#f1637b"],
        xAxis: {
          type: 'category',
          data: ['本科', '研究生', '博士', '博士后', '大专']
        },
        yAxis: {
          type: 'value'
        },
  ...
  methods: {
    initGraphic() {
      echarts.init(this.$refs.grade_id_education).setOption(this.edu_option);
      echarts.init(this.$refs.grade_id_age).setOption(this.age_option);
      echarts.init(this.$refs.grade_id_online).setOption(this.online_option);
      echarts.init(this.$refs.grade_id_job).setOption(this.grade_option);
      echarts.init(this.$refs.grade_id_perclassify).setOption(this.per_classify_option);
    },
    goTarget(href) {
